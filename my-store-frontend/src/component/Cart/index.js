        ...
        <>
            <div className='w-full bg-[#ccc] h-full relative'>
                ...
                <div className='flex flex-col gap-2 mt-5 h-5/6 overflow-auto'>
                    ...
                    {!currentUser && cartProducts.length === 0 && <h1 className='m-4 text-xl font-semibold'>Bạn chưa đăng nhập!</h1>}
                </div>
                ...
                <div className='w-[400px] flex flex-col gap-6' >
                    ...
                    <div>
                        <div className='flex gap-2 flex-col'>
                            ...
                            <input name='phoneNumber' onChange={handleChange} className='h-10 border rounded-md ' type='text' />
                        </div>
                        <div className='flex gap-2 flex-col'>
                            <label>Địa chỉ</label>
                    ...
                    <div className='flex justify-between'>
                        <button onClick={handleAddOrder} className='h-10 bg-violet-600 font-semibold text-base text-white rounded-lg shadow-lg px-4'>Đặt hàng</button>
                    </div>
                </div>
            </Modal>
        </>
